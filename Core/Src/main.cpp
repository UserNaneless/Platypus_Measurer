...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1_RGB_RED_Pin|LED1_RGB_GREEN_Pin|LED1_RGB_BLUE_Pin|B_ACCELEROMETER_Pin
                          |B_GYROSCOPE_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED1_RGB_RED_Pin|LED1_RGB_GREEN_Pin|GPIO_PIN_10|LED1_RGB_BLUE_Pin
                          |B_ACCELEROMETER_Pin|B_GYROSCOPE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
